...
- `references/local-architecture/workflow.md`: Phases, routing, and workflow-state body files referenced by `.trellis/workflow.yaml`.
...
- `.trellis/workflow.yaml` is the local workflow source of truth.
