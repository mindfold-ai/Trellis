...
# workflow text up front, we just nudge the AI to read the `start` skill once.
...
If you have not already loaded Trellis context this session, read the `start` skill once:
