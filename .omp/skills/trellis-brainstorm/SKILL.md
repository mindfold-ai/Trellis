...
```bash
TASK_DIR=$(python3 ./.trellis/scripts/task.py create "brainstorm: <short goal>" --creator <creator> --assignee <assignee> --description "<one-line summary>" --slug <auto>)
```
...
```bash
# Create child tasks
CHILD1=$(python3 ./.trellis/scripts/task.py create "Child task 1" --creator <creator> --assignee <assignee> --description "First slice of the parent task" --slug child1 --parent "$TASK_DIR")
CHILD2=$(python3 ./.trellis/scripts/task.py create "Child task 2" --creator <creator> --assignee <assignee> --description "Second slice of the parent task" --slug child2 --parent "$TASK_DIR")
